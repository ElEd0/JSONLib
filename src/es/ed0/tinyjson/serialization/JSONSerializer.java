...
/**
 * Class for serializating plain java objects into JSONObjects, arrays into JSONArrays and viceversa. 
 */
public class JSONSerializer {
	 ...
	 * @throws JSONException If an error ocurred during serialization.
	 ...
	 * Use collection.toArray() to return a usable array with the collection contents. A JSONArray may be passed for reserialization.
	 * @param o Array to serialize
	...
	/**
	 * Reserialize a JSONObject so any object or array contained in it will be serialized into its json counter part
	 * @param obj JSONObject to reserialize
	...
	/**
	 * Reserialize a JSONArray so any object or array contained in it will be serialized into its json counter part
	 * @param obj JSONArray to reserialize
	 * @return An identical json fully serialized
	 * @throws JSONException If any of the contents failed to serialize
	 */
	 ...
	 * Primitive types will return themselves. JSONObjects and JSONArrays will be reserialized, 
	 ...
	 * @param obj Objects to serialize or reserialize
	 * @return serialized object, this can be a primitive type a JSON or null
	 * @throws JSONException If teh serialization could not be done
	 */
	 ...
	 * @param clazz Class types to deserialize to
	...
	/**
	 * Receivess a JSONArray and a simple array type and returns a deserialized version of the json
	 ...
	 * @throws JSONException If deserializtaion failed. 
	 */
