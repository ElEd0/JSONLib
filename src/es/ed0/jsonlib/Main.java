...
public class Main {
	...
	private Main() throws JSONException {
        ...
        for(Object o : j.getJSONObject("json1").getJSONArray("array1").getJSONArray(2)) {
        	System.out.println(o + " -> " + (o == null ? "" : o.getClass().getName()));
        }
        
        System.out.println(j.getJSONObject("json1").getJSONArray("array1").getJSONArray(2).size());
